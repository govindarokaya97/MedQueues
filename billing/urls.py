...
urlpatterns = [
    ...
    path('<int:id>/payment/', views.BillPaymentView.as_view(), name='bill_payment'),
    path('<int:id>/pay/', views.mark_bill_paid , name='bill_pay'),
    path("<int:id>/pdf/", views.bill_pdf, name="bill_pdf"),
